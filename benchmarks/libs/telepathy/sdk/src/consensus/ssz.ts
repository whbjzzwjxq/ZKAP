...
export function hashBeaconBlockHeader(header: phase0.BeaconBlockHeader): Uint8Array {
    return ssz.phase0.BeaconBlockHeader.hashTreeRoot(header);
}

export function hashSyncCommittee(syncCommittee: altair.SyncCommittee): Uint8Array {
...
export function computeDomain(forkVersion: Uint8Array, genesisValidatorsRoot: Uint8Array) {
