...
import { toLittleEndian, hexToBigIntArray, truncateHexPrefix } from '../consensus/ssz';
import { PointG1, PointG2 } from '@noble/bls12-381';
import { bigIntToArray, pointToBigInt } from './bigint';

export type CircomInput = { [index: string]: object | bigint };
...
export class CircomSerializer {
    ...
    writeG1PointAsBigInt(name: string, point: Uint8Array, n = 55, k = 7) {
        ...
        this.buffer[name] = [bigIntToArray(n, k, bigints[0]), bigIntToArray(n, k, bigints[1])];
    }
