...
export declare type ValueOf<T extends CompositeValue, V extends keyof T = keyof T> = T extends ArrayLike<any> ? T[number] : T[V];
export declare type TreeBacked<T extends CompositeValue> = ITreeBacked<T> & T;
/**
